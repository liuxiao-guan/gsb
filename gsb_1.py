...
MODEL_DIRS = ["firstblock_taylorseer0.07_300", "origin_300", "firstblock_taylorseer0.09_300_28"]
OUTPUT_HTML = "study_1.html"
...
function downloadResults() {
    ...
    dlAnchor.setAttribute("download", "comparison_results_1.json");
